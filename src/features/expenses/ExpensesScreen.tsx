    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: theme.bg }}>
      <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <Card style={styles.summaryCard}>
          <Text style={[styles.summaryLabel, { color: theme.textSecondary }]}>Total gastado en {MONTHS[selectedMonth]}</Text>
          <Text style={[styles.summaryAmount, { color: theme.textPrimary }]}>{formatCOP(totalSpent)}</Text>
          <Chip label="+8.2% vs mes anterior" color={Colors.danger} style={{ marginTop: 8 }} />
        </Card>
